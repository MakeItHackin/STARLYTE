...
#KNCHOPEM7 IS A GOOD WEATHER STATION IN FAYETTEVILLE, NC THAT OUTPUTS SOLAR DATA
fileName = "http://api.wunderground.com/api/" + key +    "/alerts/astronomy/hourly/geolookup/tide/conditions/forecast/q/pws:KNCHOPEM7.json"
